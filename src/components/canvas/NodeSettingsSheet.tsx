...
export function NodeSettingsSheet({ nodeId, onClose }: NodeSettingsSheetProps) {
  ...
  const isAgent = nodeType === 'agent' || nodeType === 'agentNode';
  const isApi = nodeType === 'api' || nodeType === 'apiNode' || nodeType === 'apiFetcher';
  const isRag = nodeType === 'rag' || nodeType === 'ragNode';
  const isInput = nodeType === 'input' || nodeType === 'inputNode';
        ...
        {isAgent && (
          <>
            ...
            <div>
              ...
              <textarea
                rows={5}
                value={data.instructions || data.systemInstructions || data.systemPrompt || ''}
